#!/usr/bin/env python3
"""Pairwise bisect A: huihui + SIQ-1 (UniMath dropped). Router from donor[0]=huihui."""
import json
...
_DEFAULT_OUTPUT_PATH = "/Volumes/Scratch/ml-workspace/merged/pair_A_huihui_siq1_bf16"
WEIGHTS = [0.45, 0.40]
DENSITIES = [0.55, 0.50]
DENSITY = 0.5
...
def merge_qwen_moe(anchor_path: str = _DEFAULT_ANCHOR_PATH,
    ...
    print("=== Pairwise Bisect A: huihui + SIQ-1 (UniMath dropped) ===")
