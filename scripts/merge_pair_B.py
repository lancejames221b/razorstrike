#!/usr/bin/env python3
"""Pairwise bisect B: huihui + UniMath (SIQ-1 dropped). Router from donor[0]=huihui."""
import json
...
_DEFAULT_OUTPUT_PATH = "/Volumes/Scratch/ml-workspace/merged/pair_B_huihui_unimath_bf16"
WEIGHTS = [0.45, 0.25]
DENSITIES = [0.55, 0.45]
DENSITY = 0.5
...
def merge_qwen_moe(anchor_path: str = _DEFAULT_ANCHOR_PATH,
    ...
    print("=== Pairwise Bisect B: huihui + UniMath (SIQ-1 dropped) ===")
